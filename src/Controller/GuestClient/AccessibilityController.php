...
class AccessibilityController extends AbstractController
{
    ...
    {
        return $this->render('GuestClient/accessibility/index.html.twig', [
    ...
    {   
        return $this->render('GuestClient/my_account/Accessibility.html.twig', [
    ...
    {
        return $this->render('GuestClient/my_account/AccessibilityCursor.html.twig', [
            'controller_name' => 'MyAccountController',
        ]);
    }
